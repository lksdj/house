...
<head>
   ...
   <%-- <script type="text/javascript" src="${pageContext.request.contextPath }/js/xadmin.js"></script>--%>
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/dept/all.js"></script>
 ...
 <div class="x-nav">
    ...
    <div class="x-body">
      ...
      <div class="layui-btn-group">
        ...
        <a href="${pageContext.request.contextPath }/dept.do?method=revocation" class="layui-btn layui-btn-primary">已撤销部门</a>
   	  </div>
      	<!-- 操作列 -->
