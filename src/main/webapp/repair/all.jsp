...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/repair/all.js"></script>
    ...
    <div class="x-body">
     <div class="layui-row">
		...
		<div id="barDemo" style="display: none;">
			<a  lay-event="add" title="维修"> <i class="layui-icon layui-icon-form"></i></a>
		</div>
