...
<title>无标题文档</title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/emp/upd.js"></script>
	<input type="hidden" id="path" value="${pageContext.request.contextPath }/">
	<input type="hidden" id="eid" value="<%=request.getParameter("eid")%>">
...
<form class="layui-form" action="javascript:;"> 
    ...
    <div class="layui-form-item">
	    <div class="layui-inline">
	      ...
	      <div class="layui-input-inline">
	        <input type="tel" id="ename" lay-verify="required|phone" autocomplete="off" class="layui-input">
	      </div>
	    </div>
	    <div class="layui-inline">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" id="etel"  lay-verify="date" placeholder="" autocomplete="off" class="layui-input">
      </div>
    </div>
  </div>  
