...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/emp/revocation.js"></script>
    ...
    <!--   <div class="layui-row">
      ...
      <div class="layui-btn-group">
        ...
        <!-- <button class="layui-btn" id="add"><i class="layui-icon"></i>添加</button> -->
      	<a href="${pageContext.request.contextPath }/emp.do?method=index" class="layui-btn">未撤销员工</a>
      </div>		
      		<!-- 操作列 -->
		...
		<div id="eflag" style="display: none;">不在职</div>
