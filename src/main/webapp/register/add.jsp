...
<title>无标题文档</title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/register/add.js"></script>
...
<form class="layui-form" action="javascript:;"> 
    ...
    <div class="layui-form-item">
	    <div class="layui-inline">
	      ...
	      <div class="layui-input-inline">
	        <input type="text" id="cname" list="like" lay-verify="cname" autocomplete="off" class="layui-input" style="width: 515px;">
	          <datalist id="like">
  ...
  <div class="layui-form-item">
  		<div class="layui-inline">
	      		...
	      		<div class="layui-input-inline">
	      			<select   lay-filter="aid" id="aid" name="aid"></select>
	    ...
	    <div class="layui-inline">
		      ...
		      <div class="layui-input-inline">
		      		<select   lay-filter="sid" id="sid" name="sid"></select>
		      </div>
	    </div>
  </div>  
