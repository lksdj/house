...
<link rel="stylesheet" href="${pageContext.request.contextPath }/layui/css/layui.css" >
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/cus/add.js"></script>
...
<form class="layui-form"> 
    ...
    <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="radio" id="csex" name="csex" value="男" title="男" checked="checked">
	      <input type="radio" id="csex" name="csex" value="女" title="女">
	    </div>
  	</div>
    <div class="layui-form-item">
    <div class="layui-inline">
