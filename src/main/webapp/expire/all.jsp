...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/expire/all.js"></script>
...
<!-- 			<a  lay-event="detail" title="详情"> <i class="layui-icon layui-icon-form" id="look"></i></a>
			<a  lay-event="record" title="记录"><i class="layui-icon layui-icon-log" ></i></a>  -->
